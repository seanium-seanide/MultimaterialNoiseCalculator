...
class Ui_AddMaterialDialog(object):
    def setupUi(self, AddMaterialDialog):
        ...
        AddMaterialDialog.resize(461, 451)
    ...
    def retranslateUi(self, AddMaterialDialog):
        ...
        self.label_2.setText(QCoreApplication.translate("AddMaterialDialog", u"Absorption:", None))
        self.le_abs.setText(QCoreApplication.translate("AddMaterialDialog", u"0", None))
        self.label_3.setText(QCoreApplication.translate("AddMaterialDialog", u"Thermal Expansion Coefficient:", None))
        self.le_alpha.setText(QCoreApplication.translate("AddMaterialDialog", u"0", None))
        self.label_4.setText(QCoreApplication.translate("AddMaterialDialog", u"Beta:", None))
        self.le_beta.setText(QCoreApplication.translate("AddMaterialDialog", u"0", None))
        self.label_5.setText(QCoreApplication.translate("AddMaterialDialog", u"Thermal Conductivity:", None))
        self.le_kappa.setText(QCoreApplication.translate("AddMaterialDialog", u"0", None))
        self.label_6.setText(QCoreApplication.translate("AddMaterialDialog", u"Heat Capacity:", None))
        self.le_C.setText(QCoreApplication.translate("AddMaterialDialog", u"0", None))
        self.label_7.setText(QCoreApplication.translate("AddMaterialDialog", u"Refractive Index:", None))
        self.le_n.setText(QCoreApplication.translate("AddMaterialDialog", u"0", None))
        self.label_8.setText(QCoreApplication.translate("AddMaterialDialog", u"Young's Modulus:", None))
        self.le_Y.setText(QCoreApplication.translate("AddMaterialDialog", u"0", None))
        self.label_9.setText(QCoreApplication.translate("AddMaterialDialog", u"Poisson's Ratio:", None))
        self.label_10.setText(QCoreApplication.translate("AddMaterialDialog", u"Mechanical Loss:", None))

...
materialParams(2).name = 'TiGeO_2-ave';
materialParams(2).a = 0;
materialParams(2).alpha = 1e-6;
materialParams(2).beta = 1e-6;
materialParams(2).kappa = 1;
materialParams(2).C = 1e6;
materialParams(2).n = 1.88;
materialParams(2).Y = 74e9;
materialParams(2).prat = 0.216;
materialParams(2).phiM = 3.21e-4;

materialParams(1).name = 'SiO_2-ave';
materialParams(1).a = 0;
materialParams(1).alpha = 1e-6;
materialParams(1).beta = 1e-6;
materialParams(1).kappa = 1;
materialParams(1).C = 1e6;
materialParams(1).n = 1.445;
materialParams(1).Y = 74e9;
materialParams(1).prat = 0.216;
materialParams(1).phiM = 3.21e-4;

materialParams(3).name = 'SiO_2-bulk';

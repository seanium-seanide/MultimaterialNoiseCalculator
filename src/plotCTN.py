...
materialLayer = np.tile([0, 1], dtype=np.float64)
...
silica = Material("SiO2_ave", 2, 1e-6, 1e-6, 1, 1e6, 1.45, 74e9, 0.22, 3.21e-4)
tiGermania = Material("Ti:GeO2_ave", 0, 1e-6, 1e-6, 1, 1e6, 1.88, 74e9, 0.22, 3.21e-4)
...
silicaSubstrate = Material("SiO2-substrate_ave", 0, 1e-6, 1e-6, 1, 1e6, 1.45, 73.2e9, 0.17, 1e-9)
materialParams = [silica, tiGermania, silicaSubstrate]
...
aLayer = np.zeros(numLayers, dtype=np.float64)
